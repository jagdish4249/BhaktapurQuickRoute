package com.example.jagdishduwal.bhaktapurquickroute.util;
...
//    private int sportCategoryIndex;
    ...
    private Variable() {
        ...
        this.routingAlgorithms = "dijkstra";
...
//        this.directionsON = true;
        ...
        this.mapDirectory = "BhaktapurQuickRoute/maps/";
        this.dlDirectory = "BhaktapurQuickRoute/downloads/";
...
//            jo.put("sportCategoryIndex", getSportCategoryIndex());
    ...
    public String readFile() {
        try(FileInputStream fis = context.openFileInput("bqrsavedfile.txt");
    ...
    public boolean saveStringToFile(String file) {
        try(FileOutputStream fos = context.openFileOutput("bqrsavedfile.txt", Context.MODE_PRIVATE))
        {
