package com.example.jagdishduwal.bhaktapurquickroute.navigator;
...
import com.example.jagdishduwal.bhaktapurquickroute.util.GeoMath;
//import com.example.jagdishduwal.bhaktapurquickroute.util.LightSensor;
...
//  LightSensor lightSensor;
  ...
  com.graphhopper.android.GHAsyncTask<GeoPoint, NaviInstruction, NaviInstruction> naviEngineTask;
  ...
  public void setNavigating(Activity activity, boolean active)
  {
    ...
    if (active == false)
    {
      ...
      MapHandler.getMapHandler().setFavpointIcon(R.drawable.marker_icon_red);
      if (pos != null)
      {
...
//  }
  ...
  {
    naviEngineTask = new com.graphhopper.android.GHAsyncTask<GeoPoint, NaviInstruction, NaviInstruction>()
    {
      @Override
